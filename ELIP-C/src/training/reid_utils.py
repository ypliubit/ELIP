...
def cal_metrics(query_feature, query_label, gallery_feature, gallery_label):
    ######################################################################
    ...
    query_cam = torch.ones_like(query_label)
    gallery_cam = torch.zeros_like(gallery_label)
