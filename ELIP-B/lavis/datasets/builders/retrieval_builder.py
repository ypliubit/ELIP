...
@registry.register_builder("coco_retrieval_hard")
class COCORetrievalBuilderHard(BaseDatasetBuilder):
    train_dataset_cls = RetrievalDatasetCSV
    eval_dataset_cls = RetrievalEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/coco/hard_sample_ret.yaml"}
